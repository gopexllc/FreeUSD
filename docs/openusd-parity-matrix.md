...
- `tests/fixtures/parity_spatial_grounding.usda`
  `usdUtils` extraction of text-grounding cues from hierarchy, sibling names, world position, scaled bounds, and authored physics mass.
