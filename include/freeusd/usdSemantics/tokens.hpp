...
namespace freeusd::usdSemantics::tokens {

/// Schema tokens (OpenUSD-shaped names; clean-room).
inline freeusd::tf::Token SemanticsLabelsAPI() { return freeusd::tf::Token("SemanticsLabelsAPI"); }
inline freeusd::tf::Token semantics_labels___INSTANCE_NAME__() { return freeusd::tf::Token("semantics:labels:__INSTANCE_NAME__"); }
