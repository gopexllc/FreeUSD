...
inline freeusd::tf::Token SubLayerOffsets() { return freeusd::tf::Token("subLayerOffsets"); }
...
inline freeusd::tf::Token Comment() { return freeusd::tf::Token("comment"); }
...
inline freeusd::tf::Token CustomLayerData() { return freeusd::tf::Token("customLayerData"); }
