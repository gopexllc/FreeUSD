...
namespace freeusd::usdMtlx::tokens {

/// Schema tokens (OpenUSD-shaped names; clean-room).
inline freeusd::tf::Token MaterialXConfigAPI() { return freeusd::tf::Token("MaterialXConfigAPI"); }
inline freeusd::tf::Token config_mtlx_version() { return freeusd::tf::Token("config:mtlx:version"); }
